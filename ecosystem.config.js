    ...
    apps: [
        {
            ...
            env_development: {
                ...
                GALLAGHER_VIP_AG_URL: 'https://192.168.18.39:8904/api/access_groups/4499',
            ...
            env_production: {
                ...
                RUCKUS_USERNAME:'xxx',
                RUCKUS_PASSWORD:'xxx',
                MONGODB_CONNECTION_STR: 'mongodb://192.168.41.65:27017',
                MONGODB_CONNECTION_STR_DR: 'mongodb://192.168.131.161:27017',
                MONGODB_DATABASE: 'bios',
                SMTP_SERVER_HOST: 'smtp.office365.com',
                SMTP_SERVER_PORT: 587,
                SMTP_SERVER_USERNAME: 'tbd',
