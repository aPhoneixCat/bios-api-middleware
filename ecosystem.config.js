    ...
    apps: [
        {
            ...
            env_production: {
                ...
                RUCKUS_USERNAME:'xxx',
                RUCKUS_PASSWORD:'xxx',
                MONGODB_CONNECTION_STR: 'mongodb://bios:ZSTNulA217@192.168.41.65:27017/bios',
                MONGODB_CONNECTION_STR_DR: 'mongodb://bios:a3hspMjtHo@192.168.131.65:27017/bios',
                MONGODB_DATABASE: 'bios',
                SMTP_SERVER_HOST: 'smtp.office365.com',
                SMTP_SERVER_PORT: 587,
                SMTP_SERVER_USERNAME: 'tbd',
            ...
            env_dr: {
                ...
                RUCKUS_USERNAME:'xxx',
                RUCKUS_PASSWORD:'xxx',
                MONGODB_CONNECTION_STR: 'mongodb://bios:a3hspMjtHo@192.168.131.65:27017/bios',
                MONGODB_CONNECTION_STR_DR: 'mongodb://bios:ZSTNulA217@192.168.41.65:27017/bios',
                MONGODB_DATABASE: 'bios',
                SMTP_SERVER_HOST: 'smtp.office365.com',
                SMTP_SERVER_PORT: 587,
                SMTP_SERVER_USERNAME: 'tbd',
